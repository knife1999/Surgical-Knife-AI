  ...
  const webviewInitHost = (params) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      pages.map((page, i) => {
        ...
        const origin = `http://localhost:${"8082"}/?page=${page}`;
        webview.src = origin;
...
//# sourceMappingURL=index-DXXN3ERm.js.map
